...
worldMap[p1_X][PS_GRID_Y - 7]["color"] = floorColor
worldMap[p1_X][PS_GRID_Y - 8]["color"] = door1Color
worldMap[p1_X][PS_GRID_Y - 9]["color"] = blockColor
...
worldMap[p2_X][PS_GRID_Y - 10]["door"] = door1Color