...
PS_STARTUP = "Indigo" -- change this to the name of your main .lua file (without the .lua extension)
PS_APPLICATION = "Indigo: The Pucening" -- change this to the name of your game (locks out file menu and debugger)
