...
PS_STARTUP = "Viraleperlenspiel" -- change this to the name of your main .lua file (without the .lua extension)
PS_APPLICATION = "Viraleperlenspiel" -- change this to the name of your game (locks out file menu and debugger)
